    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                @include('admin.modules.municipios.create')
                <h3 class="card-title"></h3>
      
                <div class="card-tools">
                    @include('admin.modules.municipios.search')
                </div>
            </div>
                    <!-- /.card-header -->
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @foreach ($municipios as $municipio)
                            <tr>
                                ...
                                <td>
                                    @include('admin.modules.municipios.update')
                                    @include('admin.modules.municipios.destroy')
                                </td>
                            </tr>                            
                        @endforeach    
                        </tbody>
