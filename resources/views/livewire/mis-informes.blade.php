        ...
        <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                ...
                <a href="#" wire:click='informeSeguimientos({{ Auth::id() }})' class="small-box-footer">
                    Mas informacion <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                ...
                <a href="#" wire:click='informeTratamientos({{ Auth::id() }})' class="small-box-footer">
                    Mas informacion <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                ...
                <a href="#" wire:click='informeConsultas({{ Auth::id() }})' class="small-box-footer">
                    Mas informacion <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-danger">
                ...
                <a href="#" wire:click='informeExamenes({{ Auth::id() }})' class="small-box-footer">
                    Mas informacion <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
        </div>
    ...
    <div class="card">
      ...
      @if ($informeConsulta)
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  @else 
                      <div class="border text-center">
                          <h6 class="title">{{Auth::user()->name}} No se le realizo ninguna consulta</h5>
                      </div>
                  @endif
              </div>
          </div>
      ...
      @if ($informeExamen)
          <div class="card">
              ...
              <div class="card-body">
                  {{-- {{ @misExamenesPaciente($paciente_id) }} --}}
                  @if (@misExamenesPaciente()->count())
                      <div class="card-body table-responsive p-0">
                          <table class="table table-hover text-nowrap">
                              <thead>
                                  <tr>
                              ...
                              <tbody>
                                  <tbody>
                                      @foreach (@misExamenesPaciente() as $examen)
                                          <tr>
                                              <td>{{ $examen->nombre }}</td>
